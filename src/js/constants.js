export const PERSISTENT_STATE_KEY = 'classSchedulerState_v2';
export const CLASS_COLORS = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd', '#8c564b', '#e377c2', '#7f7f7f', '#bcbd22', '#17becf'];
export const HOUR_HEIGHT = 60;
export const MAX_AUTO_SCHEDULE_RESULTS = 20;

export const SCORING = {
    MANDATORY_WEIGHT: 10000,
    FAVORITE_PROFESSOR_WEIGHT: 2000,
    PREFERRED_WEIGHT: 50,
    LOW_PRIORITY_WEIGHT: 10,
    GAP_PENALTY: -2,
    DAY_PENALTY: -20,
    COMPACT_DAY_PENALTY: -100,
    COMPACT_GAP_PENALTY: -10
};
